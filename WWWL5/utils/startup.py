...
LOGS = logging.getLogger("اعداد سوي")
...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await WWWL5(UnblockRequest("@EE_266"))
        await WWWL5(
            UpdateNotifySettingsRequest(
                peer="t.me/Sourcecoibot",
                settings=InputPeerNotifySettings(mute_until=2**31 - 1),
            )
        )
        await WWWL5.edit_folder("@Sourcecoibot", folder=1)  # عمل ارشيف للبوت
        await WWWL5(UnblockRequest("@Sourcecoibot"))
        await WWWL5(JoinChannelRequest("@Yosr3456"))
        await WWWL5(JoinChannelRequest("@Yosr3456"))
        await WWWL5(JoinChannelRequest("@EE_266"))
        await WWWL5(JoinChannelRequest("@sasaee4"))
        await WWWL5(JoinChannelRequest("@M_A_S_E_2))
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            await WWWL5.send_message("@Sourcecoibot", "/start")
            await asyncio.sleep(1)
            await WWWL5.send_message(
                "@Sourcecoibot",
                "✘ تم بنجاح تشغيل سورس سوي 🕷",
            )
            await asyncio.sleep(1)
        ...
        try:
            if BOTLOG:
                await WWWL5.tgbot.send_file(
                    BOTLOG_CHATID,
                    "https://telegra.ph/file/c4484ad9265d4491f1c01.jpg",
                    caption="**شكرا لتنصيبك تيلثون سوي**\n**`لعرض الاوامر ارسل `.الاوامر**\n**اضغط على الزر ي الاسفل**",
        ...
        try:
            if BOTLOG:
                await WWWL5.tgbot.send_message(
                    BOTLOG_CHATID,
                    "**تم تشغيل سورس سوي بنجاح**\n➖➖➖➖➖➖➖➖➖➖\n**قناة السورس: @Yosr3456**\n**قناة الكلايش: @EE_266**\n**مطور السورس: @U_7h1**\n➖➖➖➖➖➖➖➖➖➖\n**لعرض الاوامر ارسل `.الاوامر`**",
                    buttons=[
                        (Button.url("كروب المساعدة", "https://t.me/Yosr3456"),)
                    ],
                )
        except Exception as e:
            LOGS.error(e)
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "جروب اشعارات سوي", WWWL5, Config.TG_BOT_USERNAME, descript, photobt
        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(
            "جروب تخزين سوي", WWWL5, Config.TG_BOT_USERNAME, descript, photobt
        )
